...
/*  $.ajax({
        type: "POST",//方法类型
                ...
                url: "${pageContext.request.contextPath}/decision/getDecisionAnalyse.do?id=1&type=1" ,//url
...
layui.use('table', function(){
  ...
  table.on("tool(demo)", function(obj){
    ...
    if(obj.event === 'detail'){
       ...
       window.location.href="${pageContext.request.contextPath}/decision/getDecisionAnalyse.do?id="+data.id + "&type=1";
    } 
  });
