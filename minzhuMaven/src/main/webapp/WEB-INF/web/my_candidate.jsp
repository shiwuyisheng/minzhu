...
layui.use('table', function(){
  ...
  table.on("tool(demo)", function(obj){
    ...
    layer.msg('ID：'+ data.id + ' 的查看操作');
     ...
     // layer.alert('编辑行：<br>'+ JSON.stringify(data));
      window.location.href="${pageContext.request.contextPath}/candidate/getCandidate.do?id="+data.id + "&flag=3";
    }
  });
  ...
  var tableModel = table.render({
    ...
    ,width: 892
     ,height:542
     ,toolbar: '#toolbarDemo'
    ,url: '${pageContext.request.contextPath}/candidate/showMyCandidate.do' //数据接口
    ,page: true //开启分页
