...
<a onclick="javascript:history.go(-1);" >返回</a>
  ...
  <!-- <div class="layui-form-item">
   ...
   <label class="layui-form-label" style="width: 100px;">开始竞选日期</label>
 ...
 <label class="layui-form-label" style="width: 100px;">结束竞选日期</label>
 ...
 /* 
  ...
  $.ajax({
            //几个参数需要注意一下
                ...
                url: "${pageContext.request.contextPath}/elect/addElection.do" ,//url
