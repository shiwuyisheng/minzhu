...
<div>
  ...
  <center><img src="${pageContext.request.contextPath}/${candidate.image}" alt="John" style="width:30%;heigth:100px;">
 </img></center>
 ...
 &nbsp;&nbsp; &nbsp; ${user.address} </br>
   ...
   <button class="layui-btn" id="bt" value="${candidate.id}"  param="${candidate.elect_post}"  name="bt"  type="button"> 投他/她一票</button>
