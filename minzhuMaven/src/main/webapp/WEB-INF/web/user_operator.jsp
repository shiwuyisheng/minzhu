...
<%--   <div class="layui-btn-group demoTable">
  <button class="layui-btn layui-bg-blue" onclick= "tosendletter()"id="sendLetter">发信件</button>
...
<table class="layui-table" lay-data="{width: 892, height:442, url:'${pageContext.request.contextPath}/letterbox/showuserletters.do', page:true, id:'idTest'}" lay-filter="demo">
  <thead>
    <tr>
    <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
      <!-- <th lay-data="{field:'id', width:80, sort: true, fixed: true}">ID</th> -->
      <th lay-data="{field:'title', width:120}">主题</th>
