...
<a onclick="javascript:history.go(-1);" ><i class="layui-icon layui-icon-return" style="font-size: 30px; color: #009688;"></i> </a>
   ...
   <image src="${pageContext.request.contextPath}/${candidate.image}"
  ...
  <div class="layui-form-item">
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-block"  >
     <label class="layui-form-label"  style="width:150px;height: auto;">  ${candidate.experience}</label>
    </div>
  </div> 
  <div class="layui-form-item">
...
$("input[name=sex][value='1']").attr("checked", ${user.sex} == 1 ? true : false);
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
     <label class="layui-form-label">${candidate.elect_post}</label>
         </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-inline">
