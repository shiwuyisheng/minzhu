...
<div class="layui-input-inline">
        <input type="text" name="keyword" autocomplete="off"
               placeholder="户主名/身份证号" class="layui-input" id="keyword" >
    </div>
...
layui.use('table', function(){
  ...
  table.on('toolbar(demo)', function(obj){
    ...
    switch(obj.event){
      ...
      case 'add':
        ...
        self.location="${pageContext.request.contextPath}/hukou/to_add_hukou.do"; 
        break;
  ...
  table.on("tool(demo)", function(obj){
    var data = obj.data;  
    if(obj.event === 'detail'){
       window.location.href="${pageContext.request.contextPath}/hukou/getHuKou.do?id="+data.id + "&flag=1";
      ...
      layer.confirm('确认删除？', { offset: '100px',skin: 'layui-layer-molv'},function(index){
        ...
        type: "POST",//方法类型
                dataType: "json",//预期服务器返回的数据类型
                url: "${pageContext.request.contextPath}/hukou/deleteHuKouByid.do?id="+data.id ,//url
      ...
      window.location.href="${pageContext.request.contextPath}/hukou/getHuKou.do?id="+data.id + "&flag=0";
    }
  });
...
<style>
  ...
  var tableModel = table.render({
    ...
    ,width: 650
     ...
     ,toolbar: '#toolbarDemo'
    ,url: '${pageContext.request.contextPath}/hukou/getAll.do' //数据接口
    ,page: true //开启分页
   ...
   {type:'checkbox', fixed: 'left'}
    /*  ,{field:'id', width:80, sort: true, fixed: true} */
 	...
 	,{field:'master_username',title:'户主', width:120}
      ,{field:'number',title:'人口数', width:120}
  ...
  var table = layui.table;
  table.reload('demo',{
    url:'${pageContext.request.contextPath}/hukou/getAll.do?keyword=' + keyword //,
