...
color: #336699;
 ...
 <div class='someclass'>
 <span style="font-size:22px;color:red; font-family:'幼圆';">热点关注</span>
 <br/><br/><br/>
 <ul class=list>
 <c:forEach items="${hotList}"  var="item" >
<li><span><fmt:formatDate value='${item.createDate}' type='date' pattern='yyyy年MM月dd日'/></span>
...
<li><a href="#" style="text-align: right;">查看更多...</a></li>
</ul>
