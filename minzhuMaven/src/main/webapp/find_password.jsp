...
<br/><br/>
  ...
  <div class="layui-form-item">
    <div class="layui-input-block">
      <button class="layui-btn" id="button" name="button" type="button" >重置密码</button>
    </div>
  </div>
...
</form>  <label class="layui-form-label" style="width:390px;">备注：
    只有个人信息已绑定了手机号码的用户才可以重置密码，若无绑定或者原信息有误，请联系管理员修改信息。
    <br/>
    管理员联系电话：0312-5263486
    </label>
<script>
...
$.ajax({
            //几个参数需要注意一下
                ...
                url: "${pageContext.request.contextPath}/user/clearpassword.do" ,//url
